      ...
      if (tests.hasOwnProperty(a)) {
        if (
          ...
          for (r = 0; r < n.options.aliases.length; r++)
            e.push(n.options.aliases[r].toLowerCase());
        for (t = is(n.fn, "function") ? n.fn() : n.fn, o = 0; o < e.length; o++)
          (i = e[o]),
            (s = i.split(".")),
            1 === s.length
              ? (Modernizr[s[0]] = t)
  ...
  var classes = [],
    ...
    ModernizrProto = {
      ...
      addTest: function (e, n, r) {
        tests.push({ name: e, fn: n, options: r });
      },
...
window.onload = function () {
  checkBrowser(Modernizr.es6Array);
  checkBrowser(Modernizr.es6ArrowFunctions);
  checkBrowser(Modernizr.es6Collections);
  checkBrowser(Modernizr.es6Generators);
  checkBrowser(Modernizr.es6Math);
  checkBrowser(Modernizr.es6Number);
  checkBrowser(Modernizr.es6Object);
  checkBrowser(Modernizr.es6Promises);
  checkBrowser(Modernizr.es6String);
};

function checkBrowser(element) {
  if (!element) {
    window.location.href = "scripts/message.html";
  }
}
